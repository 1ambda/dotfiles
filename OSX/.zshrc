...
plugins=(osx brew web-search git git-extras zsh-syntax-highlighting command-not-found common-aliases fasd tmux npm nvm bower grunt pyenv sbt scala heroku git-flow-completion vagrant tmuxinator docker docker-compose)
